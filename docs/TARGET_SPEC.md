...
| 2 | **Integrated FPU** | on-die 68040 FPU | ⛔ | Biggest single lift. Lead: adapt the open reverse-engineered **MC68881 VHDL** FPU (040 FPU is 68881/882-ISA-compatible). Interim: LC040 route runs FP software via the software FPSP (slow). |
