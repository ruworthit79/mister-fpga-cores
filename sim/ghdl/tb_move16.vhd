...
--
--  *** PENDING: MOVE16 is not yet implemented in the TG68 kernel (it currently
--  takes a clean line-F trap). This testbench is the ready-to-run acceptance
--  test for that work -- see the "MOVE16 implementation analysis" section in
--  docs/CPU_NOTES.md. It is intentionally NOT wired into run.sh until MOVE16
--  lands, since it will fail against the current trap behaviour. ***
--
