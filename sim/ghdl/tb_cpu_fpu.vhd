...
--
--  *** PENDING: this is the acceptance oracle for wiring the kernel's F-line
--  dispatch to fpu_040. It requires cpu_wrapper to gain fpu_fpsr/fpu_present
--  outputs and the kernel to decode $F2xx. Not in run.sh until that lands. ***
--
